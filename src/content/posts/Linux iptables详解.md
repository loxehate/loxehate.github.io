...
image: '../../assets/images/Dota-img/visage.png'
tags:
  - iptables
category: Linux
draft: false
...
![](/images/posts/iptables.png)

### 1.2 iptables的四表五链

iptables由五个表table和五个链chain以及一些规则组成：

![](/images/posts/iptables规则表，链结构.png)
...
![](/images/posts/iptables语法总结.png)

### 2.6 案例

- 案例1：默认查看filter表

![](/images/posts/iptables默认查看filter表.png)

-nL可以合起来写，但是n必须放在前面，放在后面会报错，如上图所示的报错 

- 案例2 ：查看其他表

![](/images/posts/iptables案例2查看其他表.png)

- 案例3：一键清空规则

![](/images/posts/iptables案例3一键清空规则.png)

- 案例4：设置ping不可达

![](/images/posts/iptables案例4：设置ping不可达1.png)

![](/images/posts/iptables案例4：设置ping不可达2.png)

0.0.0.0/0 代表所有主机都生效 

![](/images/posts/iptables案例4：设置ping不可达3.png)

![](/images/posts/iptables案例4：设置ping不可达4.png)

![](/images/posts/iptables案例4：设置ping不可达5.png)

-  案例5：添加

![](/images/posts/iptables案例5：添加.png)

-  案例6：插入

![](/images/posts/iptables案例6：插入.png)

不指定默认是在第一行插入添加 

- 案例7：删除

![](/images/posts/iptables案例7：删除.png)

 如果有多条一样的规则，是先删序号小的那条

- 案例8：设置默认规则

![](/images/posts/iptables案例8：设置默认规则1.png)

![](/images/posts/iptables案例8：设置默认规则2.png)
...
![](/images/posts/iptables案例1 通用.png)

-  案例2

![](/images/posts/iptables案例2通用1.png)

![](/images/posts/iptables案例2通用2.png)
...
![](/images/posts/iptablesTCP标记匹配.png)
...
![](/images/posts/iptablesICMP类型匹配1.png)

![](/images/posts/iptablesICMP类型匹配2.png)
...
![](/images/posts/iptables多端口匹配.png)
...
![](/images/posts/iptablesIP范围匹配.png)
