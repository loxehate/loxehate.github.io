...
image: '/images/posts/Hadoop架构.png'
tags:
  - Hadoop
category: 中间件
draft: false
...
![](/images/posts/MapReduce工作原理.png)

![](/images/posts/MapReduce流程.png)

![](/images/posts/MapReduce架构.png)
...
![](/images/posts/Yarn架构.png)

Yarn调度器和调度算法：FIFO、容量调度器、公平调度器

### 三、大数据技术生态体系

![](/images/posts/大数据技术生态体系.png)
...
![](/images/posts/NameNode web.png)

`SecondaryNameNode web 端访问地址`

![](/images/posts/SecondaryNameNode web.png)

`YARN web 端访问地址`

![](/images/posts/YARN web.png)
...
![](/images/posts/Hadoop版本依赖.png)

![](/images/posts/hadoop节点部署.png)
...
![](/images/posts/Hadoop namenode格式化.png)
