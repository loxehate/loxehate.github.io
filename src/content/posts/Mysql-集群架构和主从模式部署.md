...
image: '../../assets/images/Dota-img/lone_druid.png'
tags:
  - Mysql
category: 数据库
draft: false
...
![](/images/posts/MySQL 5.6并行复制原理.png)
...
![](/images/posts/配置连接主库.png)

执行 `start slave`启动slave端
再次执行`show salve status \G`

![](/images/posts/配置从库.png)

**测试**

主库插入数据

![](/images/posts/主库插入数据.png)

从库查询

![](/images/posts/从库查询.png)
