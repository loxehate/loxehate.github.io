...
image: '/images/posts/访问Harbor.png'
tags:
  - Docker
category: 云原生
draft: false
...
![](/images/posts/访问Harbor.png)

#### 4、登录 Web Harbor

输入用户名admin，默认密码（或已修改密码）登录系统。

![](/images/posts/WEB-harbor.png)
