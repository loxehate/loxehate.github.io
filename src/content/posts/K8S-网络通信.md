...
image: '/images/posts/Flannel vxlan模式跨主机通信原理.png'
tags:
  - kubernetes
category: 云原生
draft: false
...
![](/images/posts/Flannel%20vxlan%E6%A8%A1%E5%BC%8F%E8%B7%A8%E4%B8%BB%E6%9C%BA%E9%80%9A%E4%BF%A1%E5%8E%9F%E7%90%86.png)
...
![在这里插入图片描述](/images/posts/Cilium%E6%A6%82%E5%BF%B5.png)
...
![在这里插入图片描述](/images/posts/Cilium%E4%BD%BF%E7%94%A8%E5%9C%BA%E6%99%AF.png)  Cilium 提供了 CNI 和 kube-proxy replacement 功能，相比 iptables 性能要好很多。Cilium 作为第一个通过eBPF实现了kube-proxy所有功能的Kubernetes网络方案,
...
![在这里插入图片描述](/images/posts/Cilium%E6%9E%B6%E6%9E%84.png)  
...
*   可编程性 
    ...
    ![在这里插入图片描述](/images/posts/Cilium-ebpf1.png)
*   嵌入在 Linux 内核中 
...
![在这里插入图片描述](/images/posts/Cilium-ebpf2.png)                           之前这点之所以不重要，是因为对于虚拟机，管理程序在物理机的网络设备和虚拟机内部的套接字之间创建了一个自然边界。而对于容器，这一切都发生在同一个内核中。
...
![在这里插入图片描述](/images/posts/ebpf.png)
