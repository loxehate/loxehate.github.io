...
image: '../../assets/images/Dota-img/dragon_knight.png'
tags:
  - Mysql
category: 数据库
draft: false
...
![](/images/posts/二分查找法-1.png)

第二次查找

![](/images/posts/二分查找法-2.png)

第三次查找

![](/images/posts/二分查找法-3.png)

第四次查找

![](/images/posts/二分查找法-4.png)

#### 2、Hash结构

Hash底层实现是由Hash表来实现的，是根据键值 <key,value> 存储数据的结构。非常适合根据key查找value值，也就是单个key查询，或者说等值查询。其结构如下所示：

![](/images/posts/Hash结构.png)
...
![](/images/posts/辅助索引.png)

**非聚簇索引**

与InnoDB表存储不同，MyISAM数据表的索引文件和数据文件是分开的，被称为非聚簇索引结构。

![](/images/posts/非聚簇索引.png)
