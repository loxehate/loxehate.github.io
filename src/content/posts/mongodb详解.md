...
image: '/images/posts/mongodb文档.png'
tags:
  - MongoDB
category: 数据库
draft: false
...
![](/images/posts/mongo-_id键的组成.png)
...
![](/images/posts/mongo-一分片多区间.png)

在添加新分片后，MongoDB可以从每个分片取出部分数据，移动到新分片上。

![](/images/posts/mongo-分片.png)
...
![](/images/posts/mongo-副本集分片集群架构.png)
