...
description: 数据守护集群安装部署前需要额外注意操作系统、CPU、网络环境和磁盘 IO 配置情况，其他环境配置项建议请参考安装前准备工作。
image: '../../assets/images/Dota-img/queenofpain.webp'
tags:
  - 达梦
category: 数据库
draft: false
...
![](/images/posts/达梦-集群信息.png)

在非确认监视器中输入 tip 命令

![](/images/posts/dm-tip.png)

在非确认监视器中输入 show 命令

![](/images/posts/dm-show.png)

#### 2.6 手动切换主从节点

登录非确认监视器

![](/images/posts/dm-非确认监视器.png)

查看可以切换到主节点的数据库

![](/images/posts/dm-主节点的数据库.png)
