...
export const siteConfig: SiteConfig = {
	...
	// 站点 URL
	site_url: "https://loxehate.github.io",

	// 站点描述
	description: "晨亦远的技术笔记、实践记录与每日技术雷达。",
	...
	navbar: {
		...
		logo: {
			type: "url",
			value: "https://loxehate.github.io/img/dragon.png",
			valueDark: "https://loxehate.github.io/img/dragon.png",
			alt: "Loxehate",
		},
		// 导航栏标题
		title: "Loxehate",
